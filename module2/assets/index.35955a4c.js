var v=Object.defineProperty;var y=(r,e,s)=>e in r?v(r,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):r[e]=s;var i=(r,e,s)=>(y(r,typeof e!="symbol"?e+"":e,s),s);import{v as b}from"./vendor.e5975509.js";const w=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))a(t);new MutationObserver(t=>{for(const o of t)if(o.type==="childList")for(const h of o.addedNodes)h.tagName==="LINK"&&h.rel==="modulepreload"&&a(h)}).observe(document,{childList:!0,subtree:!0});function s(t){const o={};return t.integrity&&(o.integrity=t.integrity),t.referrerpolicy&&(o.referrerPolicy=t.referrerpolicy),t.crossorigin==="use-credentials"?o.credentials="include":t.crossorigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(t){if(t.ep)return;t.ep=!0;const o=s(t);fetch(t.href,o)}};w();class S{constructor(e){i(this,"parentElement");i(this,"game");i(this,"gameBody");i(this,"gameHeader");i(this,"addGame",()=>{this.game.className="game",this.game.append(this.gameHeader,this.gameBody)});i(this,"addHeader",()=>{const e=`
  ...
  `;this.gameOptions.className="game__options",this.gameOptions.innerHTML=t,this.parentElem.appendChild(this.gameOptions)});i(this,"listener",()=>{this.gameOptions.addEventListener("click",this.clickHandler),this.gameOptions.addEventListener("change",this.changeHandler)});i(this,"remove",()=>{n.isGameStop=!1,this.gameOptions.classList.remove("game__options_animate-add"),this.gameOptions.classList.add("game__options_animate-remove"),setTimeout(()=>{this.gameOptions.remove(),this.remove()},250)});i(this,"clickHandler",e=>{const s=e.target;s&&(s.classList.contains("options__btn_sound")&&this.changeSound(s),s.classList.contains("options__btn_rating_2048")&&this.openStandardRating("standard"),s.classList.contains("options__btn_rating_endless")&&this.openStandardRating("endless"),s.classList.contains("options__btn_duration")&&this.changeTypeGame(s),s.classList.contains("options__btn_step_back")&&this.stepBack())});i(this,"changeSound",e=>{d.sound?(e.innerHTML="\u{1F508}",d.sound=!1):(e.innerHTML="\u{1F50A}",d.sound=!0)});i(this,"changeTypeGame",e=>{d.gameVariant==="2048"?(e.innerHTML="Endless",d.gameVariant="Endless"):(e.innerHTML="2048",d.gameVariant="2048")});i(this,"openStandardRating",e=>{this.gameOptions&&new R(this.gameOptions,e)});i(this,"changeHandler",e=>{const s=e.target;d.difficulty=+s.value});i(this,"stepBack",()=>{this.playGame&&this.playGame.stepBack()});this.parentElem=e,this.gameOptions=document.createElement("div"),this.playGame=s,this.render(),this.listener()}}class A{constructor(e){i(this,"parentElement");i(this,"game",null);i(this,"score",null);i(this,"moves",null);i(this,"btnNewGame",null);i(this,"btnOptions",null);i(this,"gameBody",null);i(this,"options",null);i(this,"playGame",null);i(this,"move",e=>{this.playGame&&this.playGame.step(e)});i(this,"activeParts",()=>{this.game=this.parentElement.querySelector(".game"),this.game&&(this.score=this.game.querySelector(".info-game__score"),this.moves=this.game.querySelector(".info-game__time"),this.btnNewGame=this.game.querySelector(".game__new-game-btn"),this.btnOptions=this.game.querySelector(".game__options-btn"),this.gameBody=this.game.querySelector(".game__body"))});i(this,"addListeners",()=>{this.btnNewGame&&this.btnNewGame.addEventListener("click",this.newGame),this.btnOptions&&this.btnOptions.addEventListener("click",this.openOptions)});i(this,"newGame",()=>{if(this.game&&this.score&&this.moves&&this.gameBody&&!n.isGameStop){this.playGame=null,n.gameStarts(),l.removeAllElements(this.gameBody,"game-cell");const e=new L(this.game).render;this.playGame=new T(this.score,this.moves,this.gameBody,e)}});i(this,"openOptions",()=>{this.game&&this.btnOptions&&(this.options?(this.options.remove(),this.options=null,this.btnOptions.innerHTML="\u2699\uFE0F"):(this.options=new k({parentElem:this.game,playGame:this.playGame}),this.btnOptions.innerHTML="\u2716"))});this.parentElement=e,this.activeParts(),this.addListeners(),this.gameBody&&(new u(this.gameBody,this.move),new E(this.move))}}class G{constructor(){new S(document.body),new A(document.body)}}new G;
